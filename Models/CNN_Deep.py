...
model.add(Conv2D(128, kernel_size = (3,2), input_shape = (feature_x, feature_y, 1)))
model.add(MaxPooling2D(pool_size = (3, 2), strides = (1,1)))
model.add(BatchNormalization())

for i in range (5):
	model.add(Conv2D(128, kernel_size = (3,3), input_shape = (feature_x, feature_y, 1), padding = 'same'))
